...
""" 
understanding
s = binary string, n = length 
s0 = binary string init

invariants

a) remove suffix of s and place it at end of t 
b) remove suffix from t and place t at end of s

goal)
minimum number of moves to make s contain only 0 and t contain only 1
